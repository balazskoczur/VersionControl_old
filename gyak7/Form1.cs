...
namespace gyak7
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            Population = GetPopulation(@"C:\Temp\Windows\nép.csv");
            BirthProbabilities = GetBirthProbabilities(@"C:\Temp\Windows\születés.csv");
            DeathProbabilities = GetDeathProbabilities(@"C:\Temp\Windows\halál.csv");
